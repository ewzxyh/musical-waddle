...
const Card: React.FC = () => {
    return (
        <div className="card text-lg pt-4 bg-white z-[-50] mt-[-90em]">
            <Image src="/product.webp" alt="Roupas para Bebê" width={300} height={300} />
            ...
            <Image src="/product.webp" alt="Acessórios para Bebê" width={300} height={300} />
            ...
            <Image src="/product.webp" alt="Mochila para Bebê" width={300} height={300} />
            ...
            <Image src="/product.webp" alt="Cobertor para Bebê" width={300} height={300} />
